  ...
  <body>
    ...
    <section class="ftco-section">
      <?php
                ...
                $query = "SELECT * FROM tb_blog WHERE id_blog='$id_blog'";
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-md-12 text-center d-flex ftco-animate">
          	<div class="blog-entry justify-content-end mb-md-5">
                <h3 class="heading mt-2" align="left"><?php echo $data ['judul']?></h3>
              <a href="#" class="block-20 img" align="left">
              <img src="images/<?php echo $data ['gambar']; ?>">
              </a>
              <div class="text px-md-5 pt-4" align="left">
              <p align="left"><?php echo $data ['konten']?></p>
              </div>
            </div>
          </div>
          <?php } ?>
